...
- gzipped VCF file containing allele counts and frequencies for every position and library (:information_source: The original PDF of how to read & understand a VCF file is in this folder :information_source:)
